...
export interface DateRangePickerSlotsComponent extends DesktopDateRangePickerSlotsComponent {}

export interface DateRangePickerSlotsComponentsProps extends DesktopDateRangePickerSlotsComponentsProps {}
 ...
 */
export const DateRangePicker = React.forwardRef(function DateRangePicker<TInputDate, TDate = TInputDate>(
  inProps: DateRangePickerProps<TInputDate, TDate>,
  ref: React.Ref<HTMLDivElement>
) {
  const props = useThemeProps({ props: inProps, name: 'MuiDateRangePicker' });

  const { PopperProps, PaperProps, TransitionComponent, ...other } = props;
